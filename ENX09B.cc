...
// ENX09B.cc — два послідовних Be-циліндра, джерело gamma з довільною енергією (макро або консоль),
...
namespace ENX09B
{
    ...
    public:
        ...
        GammaEntrySD(const G4String& name)
            : G4VSensitiveDetector(name), hist_(ENX09B::NUM_BINS, 0) {
        ...
        G4bool ProcessHits(G4Step* step, G4TouchableHistory*) override {
            ...
            int bin = static_cast<int>(E / ENX09B::BIN_WIDTH);
    ...
    public:
        G4VPhysicalVolume* Construct() override {
            ...
            // SD-диск на виході другого блоку
            ...
            fGammaEntryLV = new G4LogicalVolume(sdSolid, vacuum, "NeutronExitLV");
            fGammaEntryLV->SetVisAttributes(wireOnly(G4Colour(1.0, 0.0, 0.0)));
            new G4PVPlacement(nullptr, { 0,0,sdZ }, fGammaEntryLV, "NeutronExitPV", worldLV, false, 0, true);
...
public:
  ...
  public:
        ...
        // Генерація енергії gamma rejection sampling
        static double SampleGammaEnergy() {
            constexpr double xmin = 1.0;
            constexpr double xmax = 8.7;
            constexpr double pdf_max = 500.0; // запас по максимуму PDF
            while (true) {
  ...
  public:
      ...
      void EndOfRunAction(const G4Run*) override {
          if (!isMaster_) {
              ...
              if (auto* sd = dynamic_cast<ENX09B::GammaEntrySD*>(base)) {
          ...
          for (size_t i = 0; i < mergedHist_.size(); ++i) {
              double e = (i + 0.5) * ENX09B::BIN_WIDTH;
              csv << ENX09B::fmt_comma(e) << ";" << mergedHist_[i] << "\n";
          }
...
int main(int argc, char** argv) {
    G4cout << "===================================================" << G4endl;
    G4cout << " ENX09B Simulation Program Version 0.2" << G4endl;
    G4cout << " == Enterprise project Version 9.2 ==" << G4endl;
